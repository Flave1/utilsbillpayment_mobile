...
class NumberListDialogAdapter (internal var meterListModels: MutableList<MeterListResults>, internal var context: Context, var itemClickListeners:ItemClickListener) : RecyclerView.Adapter<NumberListDialogAdapter.ViewHolder>(), View.OnClickListener {
