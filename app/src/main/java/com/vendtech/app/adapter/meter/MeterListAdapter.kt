...
class  MeterListAdapter(internal var meterListModels: MutableList<MeterListResults>, internal var context: Context,var itemEditable:Boolean,var itemClickListeners:ItemClickListener) : RecyclerView.Adapter<ViewHolder>(), View.OnClickListener {
