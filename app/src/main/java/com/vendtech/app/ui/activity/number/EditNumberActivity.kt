...
class EditNumberActivity : Activity(), View.OnClickListener {
...
//        meterAddress.setText(maddress)
    ...
    private fun bindSpMeterMake() {
        ...
        meterMakeAdapter = NumberMakeAdapter(this, list)
    ...
    fun EditNumber() {
        ...
        val call: Call<AddMeterModel> = Uten.FetchServerData().update_number(SharedHelper.getString(this, Constants.TOKEN),
        ...
        call.enqueue(object : Callback<AddMeterModel> {
            override fun onResponse(call: Call<AddMeterModel>, response: Response<AddMeterModel>) {
                ...
                if (data != null) {
                    Utilities.shortToast(data.message, this@EditNumberActivity)
                    if (data.status.equals("true")) {
                        onBackPressed()
                        finish()
                    } else {
                        Utilities.CheckSessionValid(data.message, this@EditNumberActivity, this@EditNumberActivity)
                    }
                }
            }
